...
<h2 id="internal-raft-basics">1 Raft basics</h2>
...
<h3 id="internal-leader-election">1.1 Leader election</h3>
...
<h3 id="internal-log-replication">1.2 Log replication</h3>
...
<h3 id="internal-membership-changes">1.3 Membership changes</h3>
...
<h2 id="internal-the-copycat-cluster">2 The Copycat cluster</h2>
...
<h2 id="internal-client-interaction">3 Client interaction</h2>
...
<h3 id="internal-sessions">3.1 Sessions</h3>
...
<h3 id="internal-session-lifecycle-management">3.2 Session lifecycle management</h3>
...
<h3 id="internal-commands">3.3 Commands</h3>
...
<h4 id="internal-preserving-program-order">3.3.1 Preserving program order</h4>
...
<h4 id="internal-linearizable-semantics">3.3.2 Linearizable semantics</h4>
...
<h3 id="internal-queries">3.4 Queries</h3>
...
<h4 id="internal-processing-queries-on-followers">3.4.1 Processing queries on followers</h4>
...
<h4 id="internal-ensuring-state-progresses-monotonically">3.4.2 Ensuring state progresses monotonically</h4>
...
<h3 id="internal-session-expiration">3.5 Session expiration</h3>
...
<h3 id="internal-replicating-server-configurations">3.6 Replicating server configurations</h3>
...
<h3 id="internal-ensuring-time-progresses-monotonically">3.7 Ensuring time progresses monotonically</h3>
...
<h3 id="internal-preventing-disruptions-due-to-leader-changes">3.8 Preventing disruptions due to leader changes</h3>
...
<h2 id="internal-state-machines">4 State machines</h2>
...
<h3 id="internal-deterministic-scheduling">4.1 Deterministic scheduling</h3>
...
<h2 id="internal-session-events">5 Session events</h2>
...
<h3 id="internal-publishing-events-from-the-state-machine">5.1 Publishing events from the state machine</h3>
...
<h3 id="internal-sequencing-events-on-the-client">5.2 Sequencing events on the client</h3>
...
<h3 id="internal-managing-server-memory">5.3 Managing server memory</h3>
...
<h3 id="internal-linearizable-session-events">5.4 Linearizable session events</h3>
...
<h3 id="internal-recovering-messages-after-a-server-failure">5.5 Recovering messages after a server failure</h3>
...
<h3 id="internal-managing-log-compaction">5.6 Managing log compaction</h3>
...
<h2 id="internal-dynamic-membership-changes">6 Dynamic membership changes</h2>
...
<h3 id="internal-active-members">6.1 Active members</h3>
...
<h3 id="internal-passive-members">6.2 Passive members</h3>
...
<h3 id="internal-reserve-members">6.3 Reserve members</h3>
...
<h3 id="internal-passive-replication">6.4 Passive replication</h3>
...
<h3 id="internal-promoting-passive-members">6.5 Promoting passive members</h3>
...
<h3 id="internal-demoting-active-members">6.6 Demoting active members</h3>
...
<h3 id="internal-determining-availability">6.7 Determining availability</h3>
...
<h2 id="internal-the-copycat-log">7 The Copycat log</h2>
...
<h3 id="internal-structure-of-the-log">7.1 Structure of the log</h3>
...
<h3 id="internal-log-indexes">7.2 Log indexes</h3>
...
<h2 id="internal-log-compaction">8 Log compaction</h2>
...
<h3 id="internal-cleaning-entries-from-the-log">8.1 Cleaning entries from the log</h3>
...
<h3 id="internal-basics-of-log-compaction">8.2 Basics of log compaction</h3>
...
<h3 id="internal-combining-log-segments">8.3 Combining log segments</h3>
...
<h3 id="internal-removing-tombstones-from-the-log">8.4 Removing tombstones from the log</h3>
...
<h3 id="internal-ensuring-tombstones-are-applied-on-all-servers">8.5 Ensuring tombstones are applied on all servers</h3>
...
<h3 id="internal-preventing-race-conditions-in-major-compaction">8.6 Preventing race conditions in major compaction</h3>
...
<h3 id="internal-liveness-in-major-compaction">8.7 Liveness in major compaction</h3>
...
<h3 id="internal-managing-time-and-timeouts-in-a-compacted-log">8.8 Managing time and timeouts in a compacted log</h3>
...
Nevertheless, it's clear to us that managing time and expirations through the Raft log poses significant challenges for systems that rely on log cleaning. Thus, we recommend that compaction for time-based commands be managed through snapshots as described in section [8.10](#internal-snapshots-via-log-cleaning).

<h3 id="internal-handling-configuration-changes">8.9 Handling configuration changes</h3>
...
<h3 id="internal-combining-snapshots-and-log-cleaning">8.11 Combining snapshots and log cleaning</h3>
...
<h3 id="internal-managing-session-events-for-snapshotted-logs">8.12 Managing session events for snapshotted logs</h3>
