...
* [Copycat internals](internals)
   ...
   * [8 Log compaction](#log-compaction)
      * [8.1 Log compaction strategies](#log-compaction-strategies)
         ...
         * [8.1.3 Log-structured merge trees](#log-structured-merge-trees)
      * [8.2 Log compaction algorithm](#log-compaction-algorithm)
         * [8.2.1 Marking entries for removal from the log](#marking-entries)
         * [8.2.2 Basics of log compaction](#segment-selection)
         * [8.2.3 Combining log segments](#log-segment-compaction)
         * [8.2.4 Removing tombstones from the log](#log-tombstones)
         ...
         * [8.2.8 Managing time and timeouts in a compacted log](#log-compaction-time)
         * [8.2.9 Handling membership changes in log compaction](#log-compaction-membership-changes)
      * [8.3 Implementing snapshots via log compaction](#snapshots-via-log-compaction)
         * [8.3.1 Combining snapshots and log compaction](#log-compaction-snapshots)
         * [8.3.2 Managing session events for snapshotted logs](#snapshot-session-events)
