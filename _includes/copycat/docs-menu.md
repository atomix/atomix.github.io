...
* [Working with Servers](server)
   ...
   * [Listening for Server State Changes](#listening-for-server-state-changes)
...
* [Working with Clients](client)
   ...
   * [Configuring the Client](#configuring-the-client)
      ...
      * [Server Selection Strategies](#server-selection-strategies)
   ...
   * [Listening for Client State Changes](#listening-for-client-state-changes)
