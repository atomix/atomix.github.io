...
* [Managing state in Copycat with resources](distributed-resources#distributed-resources)
...
* [I/O & Serialization](io-serialization#io--serialization)
   * [Buffers](#buffers)
      * [Bytes](#bytes)
...
* [Raft consensus algorithm](raft-consensus#raft-consensus-algorithm)
