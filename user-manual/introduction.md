...
{:.bs-callout .bs-callout-info} In order to ensure consistency, Copycat's consensus protocol requires that a majority of the cluster be available to service reads and writes.
